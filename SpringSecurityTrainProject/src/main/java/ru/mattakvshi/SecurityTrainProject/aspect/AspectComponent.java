package ru.mattakvshi.SecurityTrainProject.aspect;
...
public class AspectComponent {
    ...
    @AfterReturning(pointcut = "execution(* ru.mattakvshi.SecurityTrainProject.service.CompanyServiceImpl.*(..))", returning = "result")
